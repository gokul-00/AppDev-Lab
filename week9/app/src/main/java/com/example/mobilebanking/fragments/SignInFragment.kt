...
import com.example.mobilebanking.databinding.FragmentSignInBinding
...
class SignInFragment : Fragment() {
    ...
    private var binding by viewLifecycle<FragmentSignInBinding>()
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    if (!isPhoneAlreadyRegistered()) {
                        withContext(Dispatchers.Main) {
                            showErrorMessage("Phone number is not registered")
                        }
                        return@launch
                    } else {
                        withContext(Dispatchers.Main) {
    ...
    private fun showOtpEditText() {
        ...
        binding.buttonSignIn.text = "Verify"
    }
